...
AI = Symbol("AI")
Datascience = Symbol("Datascience")
CS = Symbol("CS")
...
def infer_eligible_programs(facts):
    ...
    majors_kb = And(
        Implication(Eligible_All_BSc, And(Mechanical, Electrical, Energy, AI, Datascience, CS, Industrial, Cyber, Architecture)),
        Implication(Eligible_BSc, And(Mechanical, Electrical, Energy, Cyber, Architecture)),
        Implication(Eligible_Tech, And(Mechanical, Electrical, Energy, AI, Datascience, CS, Industrial, Cyber, Architecture, Game_design)),
    )
    ...
    all_majors = [Mechanical, Electrical, Energy, AI, Industrial, Datascience,
